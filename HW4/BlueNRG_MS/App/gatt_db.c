...
tBleStatus Add_HWServW2ST_Service(void)
{
  ...
  ret =  aci_gatt_add_char(HWServW2STHandle, UUID_TYPE_128, char_uuid.Char_UUID_128,
                           2+2+4,
						   CHAR_PROP_BROADCAST|CHAR_PROP_READ|CHAR_PROP_WRITE_WITHOUT_RESP|CHAR_PROP_WRITE|CHAR_PROP_NOTIFY|CHAR_PROP_INDICATE|CHAR_PROP_SIGNED_WRITE|CHAR_PROP_EXT,
